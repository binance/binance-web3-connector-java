...
public class GetGasLimitRequest {
    ...
    public GetGasLimitRequest binanceChainId(@jakarta.annotation.Nonnull String binanceChainId) {
    ...
    public String toString() {
        ...
        sb.append("class GetGasLimitRequest {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetGasLimitRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetGasLimitRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetGasLimitRequest is not found in the"
                                        + " empty JSON string",
                                GetGasLimitRequest.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetGasLimitRequest.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetGasLimitRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetGasLimitRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetGasLimitRequest> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(GetGasLimitRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<GetGasLimitRequest>() {
                        @Override
                        public void write(JsonWriter out, GetGasLimitRequest value)
                                throws IOException {
                        ...
                        @Override
                        public GetGasLimitRequest read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetGasLimitRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetGasLimitRequest
     * @throws IOException if the JSON string is invalid with respect to GetGasLimitRequest
     */
    public static GetGasLimitRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetGasLimitRequest.class);
    }

    /**
     * Convert an instance of GetGasLimitRequest to an JSON string
     *
     * @return JSON string
     */
