...
public class VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted {
    ...
    public VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted token(
    ...
    public VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted amount(
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted
                ...
                // 'VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted' and its subtypes
            }
     ...
     * VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted given an
     * JSON string
     *
     ...
     * VerifyB402PaymentV2RequestBodyPaymentPayloadPayloadPermit2AuthorizationPermitted to an JSON
     * string
     *
     * @return JSON string
     */
